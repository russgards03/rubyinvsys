<div id="third-submenu">
    <a href="index.php?page=usersproducts&subpage=products">List Products</a> | <a href="index.php?page=usersproducts&subpage=products&action=create">Create Products</a>
</div>
<div id="subcontent">
    <?php
      switch($action){
