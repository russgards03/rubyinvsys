...
<a class="btn-jsactive" onclick="document.getElementById('id03').style.display='block'">Delete</a>
      <?php
    }
    ?>
</div>
...
<form method="POST" id="delete" action="processes/process.receive.php?action=delete">
      <input type="hidden" id="recid" name="recid" value="<?php echo $id;?>"/>
      </form>
      <div #id="form-update" class="modal-content">
    <div class="container">
      ...
      <div class="clearfix">
        <button class="confirmbtn" onclick="deleteSubmit()">Confirm</button>
...
function saveDelete() {
    //;window.location.href = "processes/process.receive.php?action=delete&id=<?php echo $id;?>";
