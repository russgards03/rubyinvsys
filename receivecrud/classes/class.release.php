...
class Release{
	...
	//Makes a list of all data from the release table
	...
	//New product/item to be released by the business 
	...
	//Confirms products to be released
	...
	//Confirms product quantity released
